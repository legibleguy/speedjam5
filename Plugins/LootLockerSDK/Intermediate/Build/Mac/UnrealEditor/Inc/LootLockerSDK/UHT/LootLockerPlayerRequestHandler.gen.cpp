...
void FPOtherPlayersXpAndLevelBP_DelegateWrapper(const FScriptDelegate& POtherPlayersXpAndLevelBP, FLootLockerOtherPlayersXpAndLevelResponse Value)
{
	...
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerPlayerRequestHandler_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerPlayerRequestHandler_h_Statics::ScriptStructInfo[] = {
		...
		{ FLootLockerInventory::StaticStruct, Z_Construct_UScriptStruct_FLootLockerInventory_Statics::NewStructOps, TEXT("LootLockerInventory"), &Z_Registration_Info_UScriptStruct_LootLockerInventory, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLootLockerInventory), 84708475U) },
		...
		{ FLootLockerObjects::StaticStruct, Z_Construct_UScriptStruct_FLootLockerObjects_Statics::NewStructOps, TEXT("LootLockerObjects"), &Z_Registration_Info_UScriptStruct_LootLockerObjects, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLootLockerObjects), 1900705369U) },
		...
		{ FLootLockerMultiplePlayersXpRequest::StaticStruct, Z_Construct_UScriptStruct_FLootLockerMultiplePlayersXpRequest_Statics::NewStructOps, TEXT("LootLockerMultiplePlayersXpRequest"), &Z_Registration_Info_UScriptStruct_LootLockerMultiplePlayersXpRequest, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLootLockerMultiplePlayersXpRequest), 1767679762U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerPlayerRequestHandler_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerPlayerRequestHandler_h_2928168489(TEXT("/Script/LootLockerSDK"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerPlayerRequestHandler_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerPlayerRequestHandler_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerPlayerRequestHandler_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerPlayerRequestHandler_h_Statics::ScriptStructInfo),
		nullptr, 0);
