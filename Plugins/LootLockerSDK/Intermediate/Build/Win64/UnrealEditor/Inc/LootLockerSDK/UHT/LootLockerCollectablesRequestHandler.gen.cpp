...
template<> LOOTLOCKERSDK_API UScriptStruct* StaticStruct<FLootLockerCollectablesResponse>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_LootLockerSDK_CollectablesResponseDelegateBP__DelegateSignature_Statics::NewProp_Response = { "Response", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_LootLockerSDK_eventCollectablesResponseDelegateBP_Parms, Response), Z_Construct_UScriptStruct_FLootLockerCollectablesResponse, METADATA_PARAMS(0, nullptr) }; // 2814287743
...
void FCollectablesResponseDelegateBP_DelegateWrapper(const FScriptDelegate& CollectablesResponseDelegateBP, FLootLockerCollectablesResponse Response)
{
	...
	struct Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerCollectablesRequestHandler_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerCollectablesRequestHandler_h_Statics::ScriptStructInfo[] = {
		{ FLootLockerCollectableReward::StaticStruct, Z_Construct_UScriptStruct_FLootLockerCollectableReward_Statics::NewStructOps, TEXT("LootLockerCollectableReward"), &Z_Registration_Info_UScriptStruct_LootLockerCollectableReward, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLootLockerCollectableReward), 874775448U) },
		{ FLootLockerCollectableItem::StaticStruct, Z_Construct_UScriptStruct_FLootLockerCollectableItem_Statics::NewStructOps, TEXT("LootLockerCollectableItem"), &Z_Registration_Info_UScriptStruct_LootLockerCollectableItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLootLockerCollectableItem), 1187411777U) },
		{ FLootLockerCollectableItemGroup::StaticStruct, Z_Construct_UScriptStruct_FLootLockerCollectableItemGroup_Statics::NewStructOps, TEXT("LootLockerCollectableItemGroup"), &Z_Registration_Info_UScriptStruct_LootLockerCollectableItemGroup, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLootLockerCollectableItemGroup), 3617668371U) },
		{ FLootLockerCollectable::StaticStruct, Z_Construct_UScriptStruct_FLootLockerCollectable_Statics::NewStructOps, TEXT("LootLockerCollectable"), &Z_Registration_Info_UScriptStruct_LootLockerCollectable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLootLockerCollectable), 959459548U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerCollectablesRequestHandler_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerCollectablesRequestHandler_h_3668351504(TEXT("/Script/LootLockerSDK"),
		Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerCollectablesRequestHandler_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerCollectablesRequestHandler_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerCollectablesRequestHandler_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_GameAPI_LootLockerCollectablesRequestHandler_h_Statics::ScriptStructInfo),
		nullptr, 0);
