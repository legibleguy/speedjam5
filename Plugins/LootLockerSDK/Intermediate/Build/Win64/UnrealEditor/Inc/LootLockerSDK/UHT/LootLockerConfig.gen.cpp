...
// End Cross Module References
	...
	void ULootLockerConfig::StaticRegisterNativesULootLockerConfig()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "IsSemverString", &ULootLockerConfig::execIsSemverString, ERASE_FUNCTION_PTR(&ULootLockerConfig::IsSemverString,(const FString&),ERASE_ARGUMENT_PACK(bool)) },
		};
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ULootLockerConfig_IsSemverString_Statics::NewProp_str = { "str", nullptr, (EPropertyFlags)0x3010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LootLockerConfig_eventIsSemverString_Parms, str), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULootLockerConfig_IsSemverString_Statics::NewProp_str_MetaData), Z_Construct_UFunction_ULootLockerConfig_IsSemverString_Statics::NewProp_str_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULootLockerConfig_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULootLockerConfig_IsSemverString, "IsSemverString" }, // 2802491652
	};
	...
	struct Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerConfig_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerConfig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULootLockerConfig, ULootLockerConfig::StaticClass, TEXT("ULootLockerConfig"), &Z_Registration_Info_UClass_ULootLockerConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULootLockerConfig), 3484081599U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerConfig_h_1385927516(TEXT("/Script/LootLockerSDK"),
		Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerConfig_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerConfig_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
