...
template<> LOOTLOCKERSDK_API UScriptStruct* StaticStruct<FLootLockerPlatformRepresentation>()
{
	...
	void ULootLockerCurrentPlatform::StaticRegisterNativesULootLockerCurrentPlatform()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "GetPlatformRepresentation", &ULootLockerCurrentPlatform::execGetPlatformRepresentation, ERASE_FUNCTION_PTR(&ULootLockerCurrentPlatform::GetPlatformRepresentation,(),ERASE_ARGUMENT_PACK(const FLootLockerPlatformRepresentation&)) },
			{ "GetPlatformRepresentationForPlatform", &ULootLockerCurrentPlatform::execGetPlatformRepresentationForPlatform, ERASE_FUNCTION_PTR(&ULootLockerCurrentPlatform::GetPlatformRepresentationForPlatform,(const ELootLockerPlatform),ERASE_ARGUMENT_PACK(const FLootLockerPlatformRepresentation&)) },
		};
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULootLockerCurrentPlatform_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULootLockerCurrentPlatform_GetPlatformRepresentation, "GetPlatformRepresentation" }, // 1712163893
		{ &Z_Construct_UFunction_ULootLockerCurrentPlatform_GetPlatformRepresentationForPlatform, "GetPlatformRepresentationForPlatform" }, // 1214720068
	};
	...
	struct Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULootLockerCurrentPlatform, ULootLockerCurrentPlatform::StaticClass, TEXT("ULootLockerCurrentPlatform"), &Z_Registration_Info_UClass_ULootLockerCurrentPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULootLockerCurrentPlatform), 3723050556U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_202481043(TEXT("/Script/LootLockerSDK"),
		Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerPlatformManager_h_Statics::EnumInfo));
