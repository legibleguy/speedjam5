...
template<> LOOTLOCKERSDK_API UScriptStruct* StaticStruct<FLootLockerIndexBasedPagination>()
{
	...
	struct Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerResponse_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerResponse_h_Statics::ScriptStructInfo[] = {
		...
		{ FLootLockerResponse::StaticStruct, Z_Construct_UScriptStruct_FLootLockerResponse_Statics::NewStructOps, TEXT("LootLockerResponse"), &Z_Registration_Info_UScriptStruct_LootLockerResponse, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLootLockerResponse), 1765461542U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerResponse_h_2629978294(TEXT("/Script/LootLockerSDK"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerResponse_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_cicadashell_Plugins_LootLockerSDK_Source_LootLockerSDK_Public_LootLockerResponse_h_Statics::ScriptStructInfo),
		nullptr, 0);
